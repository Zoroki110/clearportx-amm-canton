...
public class StartupValidation {
    ...
    public void validateDamlBindings() {
        ...
        if (!checkClassExists("clearportx_amm_production.amm.atomicswap.AtomicSwapProposal")) {
        ...
        if (!checkClassExists("clearportx_amm_production.amm.pool.Pool")) {
        ...
        if (!checkClassExists("clearportx_amm_production.token.token.Token")) {
        ...
        if (!checkClassExists("clearportx_amm_production.lptoken.lptoken.LPToken")) {
        ...
        if (!checkClassExists("clearportx_amm_production.amm.swaprequest.SwapRequest")) {
