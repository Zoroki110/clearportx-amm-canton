...
import static com.clearportx.utility.TracingUtils.trace;
                ...
                .thenCompose(health -> {
                    ...
                    return CompletableFuture.supplyAsync(() -> {
                        try {
                            ...
                            return com.clearportx.utility.PqsSyncUtil.pollPqsUntil(
                                    () -> {
                                        try {
